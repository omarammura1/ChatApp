...
public class AdapterGroupChat extends RecyclerView.Adapter<AdapterGroupChat.HolderGroupChat>
{
    ...
    public AdapterGroupChat(Context context, ArrayList<ModelPGroupChat> modelPGroupChats) {
...
//        calendar.setTimeInMillis(Long.parseLong(TS));tring DT = DateFormat.format("hh:mm aa", calendar);
//
